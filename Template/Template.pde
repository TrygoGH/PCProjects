...
//init var area
int xScreenWidth = 0;
int yScreenWidth = 0; //user fullscreen
// int xScreenWidth = 1920; int yScreenWidth = 1080; //1080p
// int xScreenWidth = 1280; int yScreenWidth = 720; //720p
int xCenter = xScreenWidth / 2; int yCenter = yScreenWidth / 2;
int allignL = 0; int allignR = xScreenWidth; int allignT = 0; int allignB = yScreenWidth;
int btSize = 100;
int GMtick = 0;
