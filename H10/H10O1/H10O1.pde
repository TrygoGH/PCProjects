...
int i = 0; int i2 = 0; float holder = 0; int btSize = 100;
int GMtick = 0;
...
//buttons
button1 = cp5.addButton("button1").setPosition(xCenter-(btSize/2)-100,yCenter-(btSize/4)).setSize(btSize,btSize/2).setCaptionLabel ("Click");
