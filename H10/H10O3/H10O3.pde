...
//Button area
void button1() {
  String textholder = textfield1.getText();
  float holder = int(textholder) * 1.21;
  if (holder >= 0) { 
  println("The price plus sales tax is: $ " + holder);
  } 
  else if (holder < 0) {
    println("The price plus sales tax is: $ " + holder + " enjoy your money :>");
  }
}
